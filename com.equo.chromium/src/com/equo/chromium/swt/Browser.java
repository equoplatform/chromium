...
public class Browser extends Composite {
	...
	public Browser(Composite parent, int style) {
		...
		Throwable t = null;
		try {
			Constructor<?> constructor = loadChromiumClass().getDeclaredConstructor();
			constructor.setAccessible(true);
			webBrowser = (WebBrowser) constructor.newInstance();
		} catch (ClassNotFoundException e) {
			msg = "Cannot find Chromium class, probably you are missing a chromium.swt fragment.";
			t = e;
		...
		dispose ();
		SWT.error (SWT.ERROR_NO_HANDLES, t, msg);
	}
