 ...
 */
class CefBrowserWr extends CefBrowserSwing {
    ...
    private CefWindowHandlerAdapter win_handler_ = new CefWindowHandlerAdapter() {
        ...
        @Override
        public org.cef.misc.Rectangle getRect(CefBrowser browser) {
            synchronized (content_rect_) {
                return new org.cef.misc.Rectangle(content_rect_);
            }
        }
    ...
    private void doUpdate() {
        ...
        if (OS.isMacintosh()) {
            ...
            java.awt.Point contentPos = component_.getLocation();
            while (parent != null) {
            ...
            synchronized (content_rect_) {
                ...
                updateUI(new org.cef.misc.Rectangle(content_rect_), new org.cef.misc.Rectangle(browserRect));
            ...
            synchronized (content_rect_) {
                ...
                updateUI(new org.cef.misc.Rectangle(clipping), new org.cef.misc.Rectangle(content_rect_));
            }
        }
    }
